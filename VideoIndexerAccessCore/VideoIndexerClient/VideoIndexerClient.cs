...
using VideoInexerAccessCore.VideoIndexerClient.Configuration;
using VideoInexerAccessCore.VideoIndexerClient.HttpAccess;
using VideoInexerAccessCore.VideoIndexerClient.Model;

namespace VideoInexerAccessCore.VideoIndexerClient
{
