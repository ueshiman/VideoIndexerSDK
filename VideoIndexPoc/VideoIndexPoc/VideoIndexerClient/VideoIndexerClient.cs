...
namespace VideoIndexPoc.VideoIndexerClient
{
    public class VideoIndexerClient : IVideoIndexerClient
    {
        ...
        public VideoIndexerClient(IAccountTokenProviderDynamic accountTokenProvider)
        {
        ...
        public async Task<Account> GetAccountAsync(string accountName)
        {
            ...
            {
                // Set request uri
                var requestUri = $"{Constants.AzureResourceManager}/subscriptions/{Constants.SubscriptionId}/resourcegroups/{Constants.ResourceGroup}/providers/Microsoft.VideoIndexer/accounts/{accountName}?api-version={Constants.ApiVersion}";
        ...
        public async Task GetVideoAsync(string videoId)
        {
            ...
            try
            {
                var requestUrl = $"{Constants.ApiEndpoint}/{_account.Location}/Accounts/{_account.Properties.Id}/Videos/Search?{queryParams}";
