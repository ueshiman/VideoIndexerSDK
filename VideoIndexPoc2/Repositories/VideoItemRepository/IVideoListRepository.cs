...
public interface IVideoListRepository
{
    ...
    Task<IEnumerable<VideoListItem>> ListVideosAsync(DateTimeOffset? createdAfter = null, DateTimeOffset? createdBefore = null, int? pageSize = null, int? skip = null, string[]? partitions = null);
