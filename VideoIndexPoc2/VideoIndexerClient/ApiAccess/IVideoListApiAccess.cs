...
public interface IVideoListApiAccess
{
    ...
    /// <param name="partitions">パーティション</param>
    /// <returns>ビデオリスト</returns>
    Task<IEnumerable<VideoListItem>> ListVideosAsync(string location, string accountId, string? accessToken = null, string? createdAfter = null, string? createdBefore = null, int? pageSize = null, int? skip = null, string[]? partitions = null);
}
