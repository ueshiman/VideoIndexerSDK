...
public interface IVideoItemApiAccess
{
    ...
    Task<VideoItem> GetVideoIndexAsync(string location, string accountId, string videoId, string? accessToken = null, string? language = null, bool? reTranslate = null, bool? includeStreamingUrls = null, string? includedInsights = null, string? excludedInsights = null);
