...
namespace VideoIndexPoc2.VideoIndexerClient.ApiAccess
{
    public class VideoListAccessApiAccess : IVideoListApiAccess
    {
        ...
        public VideoListAccessApiAccess(ILogger<VideoListAccessApiAccess> logger, IHttpClientFactory httpClientFactory, IAccounApitAccess accountAccess, IAccountTokenProviderDynamic accountTokenProviderDynamic, IApiResourceConfigurations apiResourceConfigurations, IVideoListParser videoListParser)
        {
            ...
            _account = _accountAccess.GetAccount();
        }
        ...
        public async Task<IEnumerable<VideoListItem>> ListVideosAsync(string? location, string? accountId, string? accessToken)
        {
        ...
        public async Task<IEnumerable<VideoListItem>> ListVideosAsync(string location, string accountId, string? accessToken = null, string? createdAfter = null, string? createdBefore = null, int? pageSize = null, int? skip = null, string[]? partitions = null)
        {
