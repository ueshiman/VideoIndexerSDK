...
namespace VideoIndexPoc2.VideoIndexerClient.ApiAccess
{
    ...
    public class VideoIndexApiAccess : IVideoItemApiAccess
    {
        ...
        public async Task<VideoItem> GetVideoIndexAsync(string location, string accountId, string videoId, string? accessToken = null, string? language = null, bool? reTranslate = null, bool? includeStreamingUrls = null, string? includedInsights = null, string? excludedInsights = null)
        {
